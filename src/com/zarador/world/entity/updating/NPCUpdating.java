...
import com.zarador.model.UpdateFlag;
import com.zarador.net.packet.ByteOrder;
import com.zarador.net.packet.PacketBuilder;
import com.zarador.net.packet.ValueType;
import com.zarador.net.packet.Packet.PacketType;
import com.zarador.net.packet.PacketBuilder.AccessType;
...
public class NPCUpdating {
	...
	/**
	 * Updates {@code npc}'s current graphics and displays it for all local
	 * players.
	 * 
	 * @param builder
	 *            The packet builder to write information on.
