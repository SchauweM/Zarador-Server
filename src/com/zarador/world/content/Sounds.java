...
public class Sounds {
	...
	public static int getPlayerBlockSounds(int wepId) {
		...
		if (wepId == 2499 || wepId == 2501 || wepId == 2503 || wepId == 4746 || wepId == 4757 || wepId == 10330) {// Dragonhide
																													// sound
			blockSound = 24;
			...
			blockSound = 14;// Robe sound
				...
				wepId == 1103 || wepId == 1105 || wepId == 1107 || wepId == 1109 || wepId == 1111 || wepId == 1113
				|| wepId == 1115 || // Plates
				wepId == 1117 || wepId == 1119 || wepId == 1121 || wepId == 1123 || wepId == 1125 || wepId == 1127
				|| wepId == 4720 || // Barrows armour
				wepId == 4728 || wepId == 4749 || wepId == 4712 || wepId == 11720 || // Godwars
																						// armour
				wepId == 11724 || wepId == 3140 || // Dragon
				wepId == 2615 || // Fancy
				wepId == 2653 || wepId == 2661 || wepId == 2669 || wepId == 2623 || wepId == 3841 || wepId == 1127) {// Metal
																														// armour
																														// sound
			blockSound = 511;
		}
	...
	public static int getPlayerAttackSound(Player c) {
		...
		String wep = ItemDefinition.forId(c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId()).getName()
				.toLowerCase();
		if (wep.contains("bow")) {
			return 370;
		}
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4718) {// Dharok's
																					// Greataxe
			return 1320;
		}
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4734) {// Karil's
																					// Crossbow
			return 1081;
		}
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4747) {// Torag's
																					// Hammers
			return 1330;
		}
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4710) {// Ahrim's
																					// Staff
			return 2555;
		}
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4755) {// Verac's
																					// Flail
			return 1323;
		}
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4726) {// Guthan's
																					// Warspear
			return 2562;
		}
		...
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 772
				...
				|| c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 9100) { // Staff
																							// wack
			return 394;
		}
		...
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 4718
				|| c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 7808) { // Dharok
																							// GreatAxe
			return 400;
		}
		...
		if (c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 2745
				|| c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 2746
				|| c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 2747
				|| c.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 2748) { // Godswords
			return 390;
		}
	...
	public static int getAreaID(Player player) {
		...
		if ((location.getX() >= 2368 && location.getX() <= 2376 && location.getY() >= 3127 && location.getY() <= 3135
				&& location.getZ() == 1)
				|| (location.getX() >= 2423 && location.getX() <= 2431 && location.getY() >= 3072
						&& location.getY() <= 3080 && location.getZ() == 1))
			return 2;
		...
		if (location.getX() > 2935 && location.getX() < 3061 && location.getY() > 3308 && location.getY() < 3396)
			return 8;
		if (location.getX() >= 2659 && location.getX() <= 2664 && location.getY() >= 2637 && location.getY() <= 2644
				|| location.getX() >= 2623 && location.getX() <= 2690 && location.getY() >= 2561
						&& location.getY() <= 2688)
			return 9;
		...
		if ((location.getX() >= 2792 && location.getX() <= 2829 && location.getY() >= 3412 && location.getY() <= 3472)
				|| (location.getX() > 2828 && location.getX() < 2841 && location.getY() > 3430
						&& location.getY() < 3459)
				|| (location.getX() > 2839 && location.getX() < 2861 && location.getY() > 3415
						&& location.getY() < 3441))
			return 22;
