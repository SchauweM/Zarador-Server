...
import com.zarador.engine.task.impl.CeilingCollapseTask;
...
public class Barrows {
	...
	public static boolean handleObject(final Player player, GameObject object) {
		switch (object.getId()) {
		case 6771:
			searchCoffin(player, object.getId(), 4, 2026, object.getPosition() != null
					? new Position(3557, 9715, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6823:
			searchCoffin(player, object.getId(), 0, 2030, object.getPosition() != null
					? new Position(3575, 9704, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6821:
			searchCoffin(player, object.getId(), 5, 2025, object.getPosition() != null
					? new Position(3557, 9699, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6772:
			searchCoffin(player, object.getId(), 1, 2029, object.getPosition() != null
					? new Position(3571, 9684, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6822:
			searchCoffin(player, object.getId(), 2, 2028, object.getPosition() != null
					? new Position(3549, 9681, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6773:
			searchCoffin(player, object.getId(), 3, 2027, object.getPosition() != null
