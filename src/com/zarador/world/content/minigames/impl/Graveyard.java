...
public class Graveyard {
	...
	public static void start(Player player) {
		...
		player.getPacketSender()
				.sendMessage("<img=4><col=FF0000><shad=0> To leave the graveyard, simply teleport out.");
	}
	...
	public static boolean handleDeath(Player player, NPC npc) {
		...
		if (amount > 0) {
			GroundItemManager.spawnGroundItem(player,
					new GroundItem(new Item(14667), npc.getPosition(), player.getUsername(), false, 150, false, -1));
