...
public class Nomad {
	...
	private static final String[] questIntro = { "Nomad is searching for a worthy opponent.",
			"Are you eligible for the job?", "", };
	private static final String[] questGuide = { "Talk to Nomad and accept his challenge to a fight.",
			"Defeat Nomad." };
}
