package com.zarador.world.content.skill.impl.farming.patch;
...
import com.zarador.util.MathUtil;
import com.zarador.world.content.skill.impl.farming.FarmingConstants;
import com.zarador.world.content.skill.impl.farming.FarmingManager;
import com.zarador.world.content.skill.impl.farming.attributes.GrowthState;
import com.zarador.world.content.skill.impl.farming.attributes.PatchAttribute;
import com.zarador.world.content.skill.impl.farming.seed.AllotmentSeedType;
import com.zarador.world.content.skill.impl.farming.seed.FlowerSeedType;
import com.zarador.world.content.skill.impl.farming.seed.SeedClass;
...
public final class Patch {
			...
			public void execute() {
				...
				if (System.currentTimeMillis() - timePlanted 
					...
					if (growthState == GrowthState.DISEASED
							&& (stage >= seedType.getValues().length - 2 || MathUtil.random(10) == 0)) {
					...
					if (isFullyGrown()) {
						if (getSeedType().getSeedClass() == SeedClass.BUSHES) {
							...
							if (getHarvestedItem().getAmount() > 0
								...
								final int amount = getHarvestedItem().getAmount() - (1 + MathUtil.random(10));
	...
	public void decreaseDiseaseImmunity() {
		diseaseImmunity -= MathUtil.random(15);
