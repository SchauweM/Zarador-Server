...
public enum leatherData {
	...
	LEATHER_GLOVES(new int[][] { { 8638, 1 }, { 8637, 5 }, { 8636, 10 } }, 1741, 1059, 1, 13.5, 1),
	...
	leatherData(final int[][] buttonId, final int leather, final int product, final int level, final double xp,
			final int amount) {
