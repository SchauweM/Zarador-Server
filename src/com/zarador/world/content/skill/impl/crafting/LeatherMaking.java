...
import com.zarador.model.input.impl.EnterAmountOfLeatherToCraft;
		...
		if (l.getLeather() == player.getSelectedSkillingItem()) {
			...
			player.setCurrentTask(new Task(2, player, true) {
				...
				public void execute() {
					...
					player.getSkillManager().addSkillExperience(Skill.CRAFTING, ((int) l.getXP()));
					if (l == leatherData.BLACK_DHIDE_BODY) {
