...
import com.zarador.engine.task.impl.HunterTrapsTask;
	...
	public static void rollPet(Player player) {
		...
		if (PET_CHANCE == 1 && player.getInventory().getFreeSlots() >= 1) {
			...
			player.getPacketSender()
					.sendMessage("You pick up the chinchompa to find you've caught it's mother aswell!");
			World.sendMessage("<icon=1><shad=FF8C38> " + player.getUsername() + " has just received "
					+ ItemDefinition.forId(PET_ID).getName() + " from the Hunter skill!");
