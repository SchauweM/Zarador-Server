...
public class RunecraftingPouches {
	...
	public enum RunecraftingPouch {
		SMALL(5509, 7, 7), MEDIUM_POUCH(5510, 16, 16), LARGE_POUCH(5512, 28, 28);
	...
	public static void check(Player p, RunecraftingPouch pouch) {
		p.getPacketSender()
				.sendMessage("Your pouch currently contains " + p.getStoredRuneEssence() + "/" + pouch.maxRuneEss
						+ " Rune essence and " + p.getStoredPureEssence() + "/" + pouch.maxPureEss + " Pure essence.");
	}
}
