package com.zarador.world.content.combat.range;
...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
																						...
																						RangedWeaponType.SHORTBOW), MAGIC_LONGBOW(
																								...
																								RangedWeaponType.LONGBOW), MAGIC_SHORTBOW(
																										...
																										new AmmunitionData[] {
																												...
																												AmmunitionData.ICE_ARROW,
																												AmmunitionData.BROAD_ARROW },
																										RangedWeaponType.SHORTBOW), TOXIC_BLOWPIPE(
																												new int[] {
																														12926 },
																												new AmmunitionData[] {
																														AmmunitionData.BLOWPIPE_DART },
																												RangedWeaponType.BLOWPIPE), ZARYTE_BOW(
																														new int[] {
																																20171 },
																														new AmmunitionData[] {
																																AmmunitionData.BRONZE_ARROW,
		...
		DARK_BOW(
				new int[] { 21016, 21017, 21018, 21019, 21020, 21021, 21022, 21023, 11235, 13405, 15701, 15702, 15703,
						15704 },
				new AmmunitionData[] { AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW,
				...
				RangedWeaponType.DARK_BOW), ROYAL_CROSSBOW(new int[] { 11624 },
						new AmmunitionData[] { AmmunitionData.ROYAL_BOLT }, RangedWeaponType.CROSSBOW), BRONZE_CROSSBOW(
								new int[] { 9174 }, new AmmunitionData[] { AmmunitionData.BRONZE_BOLT },
										...
										RangedWeaponType.CROSSBOW), STEEL_CROSSBOW(new int[] { 9179 },
												...
												RangedWeaponType.CROSSBOW), MITHRIL_CROSSBOW(new int[] { 9181 },
														...
														RangedWeaponType.CROSSBOW), ADAMANT_CROSSBOW(new int[] { 9183 },
																...
																RangedWeaponType.CROSSBOW), HIGHEST_CROSSBOWS(
																		new int[] { 9185, 18357, 14684 },
																		new AmmunitionData[] {
																				AmmunitionData.BRONZE_BOLT,
																				AmmunitionData.OPAL_BOLT,
																				AmmunitionData.IRON_BOLT,
																				AmmunitionData.JADE_BOLT,
																				AmmunitionData.STEEL_BOLT,
		...
		BRONZE_DART(new int[] { 806 }, new AmmunitionData[] { AmmunitionData.BRONZE_DART },
				RangedWeaponType.DART), IRON_DART(new int[] { 807 }, new AmmunitionData[] { AmmunitionData.IRON_DART },
						RangedWeaponType.DART), STEEL_DART(new int[] { 808 },
								new AmmunitionData[] { AmmunitionData.STEEL_DART },
								RangedWeaponType.DART), MITHRIL_DART(new int[] { 809 },
										new AmmunitionData[] { AmmunitionData.MITHRIL_DART },
										RangedWeaponType.DART), ADAMANT_DART(new int[] { 810 },
												new AmmunitionData[] { AmmunitionData.ADAMANT_DART },
												RangedWeaponType.DART), RUNE_DART(new int[] { 811 },
														new AmmunitionData[] { AmmunitionData.RUNE_DART },
														RangedWeaponType.DART), DRAGON_DART(new int[] { 11230 },
								...
								RangedWeaponType.THROW), MITHRIL_THROWNAXE(new int[] { 803 },
										...
										RangedWeaponType.THROW), ADAMANT_THROWNAXE(new int[] { 804 },
												...
												RangedWeaponType.THROW), RUNE_THROWNAXE(new int[] { 805 },
														...
														RangedWeaponType.THROW), MORRIGANS_THROWNAXE(
																new int[] { 13883, 13957 },
																new AmmunitionData[] {
																		AmmunitionData.MORRIGANS_THROWNAXE },
																RangedWeaponType.THROW),
								...
								RangedWeaponType.THROW), MITHRIL_JAVELIN(new int[] { 828 },
										...
										RangedWeaponType.THROW), ADAMANT_JAVELIN(new int[] { 829 },
												...
												RangedWeaponType.THROW), RUNE_JAVELIN(new int[] { 830 },
														...
														RangedWeaponType.THROW), MORRIGANS_JAVELIN(
																new int[] { 13879, 13953 },
																new AmmunitionData[] {
																		AmmunitionData.MORRIGANS_JAVELIN },
																RangedWeaponType.THROW),
	...
	public enum RangedWeaponType {
		...
		LONGBOW(9, 6), SHORTBOW(7, 4), BALLISTA(7, 4), CROSSBOW(7, 6), ARMADYL_CROSSBOW(8, 6), ROYAL_CROSSBOW(7, 5), THROW(4,
				3), DART(3, 3), BLOWPIPE(4, 3), DARK_BOW(9, 8), HAND_CANNON(7, 6);
