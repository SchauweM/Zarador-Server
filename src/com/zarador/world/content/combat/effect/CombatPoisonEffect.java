...
public class CombatPoisonEffect extends Task {
	...
	public void execute() {
		...
		entity.dealDamage(null, new Hit(entity.getAndDecrementPoisonDamage(), Hitmask.RED2, CombatIcon.NONE));
		/*
		 * if(entity.isPlayer()) {
	...
	public static final class CombatPoisonData {
		...
		public static void init() {
			...
			types.put(21371, PoisonType.MILD);
			types.put(21372, PoisonType.MILD);
			types.put(21373, PoisonType.MILD);
			types.put(21374, PoisonType.MILD);
			types.put(21375, PoisonType.MILD);
