...
public class BountyHunter {
	...
	/*
	 * The minimum amount of milliseconds to increase the player's target
	 * percentage
	 */
	 ...
	 * 
	 * @param player
	 *            The player to handle the logout for.
	 */
	 ...
	 * 
	 * @param c
	 *            The player to find a target for.
	 */
	 ...
	 * 
	 * @param player
	 *            The player to check status for.
	 ...
	 * 
	 * @param c
	 *            Player1 to assign target for.
	 * @param target
	 *            Player2 to assign target for.
	 */
	 ...
	 * 
	 * @param c
	 *            The player to reset target for.
	 * @param leaver
	 *            The leaver to reset target for.
	 * @param string
	 */
	...
	public static void updateInterface(Player player) {
		player.getPacketSender().sendString(25350, player.getPlayerKillingAttributes().getTarget() != null
	 ...
	 * 
	 * @param c
	 *            The player to add Target Percentage for.
	 * @param amountToAdd
	 *            How much Target Percentage the player will receive.
	 */
