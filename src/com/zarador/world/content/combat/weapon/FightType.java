...
public enum FightType {
    ...
    BATTLEAXE_HACK(401, 43, 1, BonusManager.ATTACK_CRUSH, FightStyle.AGGRESSIVE),
    BATTLEAXE_SMASH(401, 43, 2, BonusManager.ATTACK_SLASH, FightStyle.AGGRESSIVE),
    ...
    BALLISTA_ACCURATE(7222, 43, 0, BonusManager.ATTACK_RANGE, FightStyle.ACCURATE),
    BALLISTA_RAPID(7222, 43, 1, BonusManager.ATTACK_RANGE, FightStyle.AGGRESSIVE),
    BALLISTA_LONGRANGE(7222, 43, 2, BonusManager.ATTACK_RANGE, FightStyle.DEFENSIVE);
     ...
     */
    FightType(int animation, int parentId, int childId, int bonusType, FightStyle style) {
