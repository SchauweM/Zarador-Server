package com.zarador.net.packet;

import org.jboss.netty.buffer.ChannelBuffer;

import com.zarador.net.packet.impl.ButtonClickPacketListener;
import com.zarador.net.packet.impl.EquipPacketListener;
import com.zarador.net.packet.impl.ItemActionPacketListener;
...
public class Packet {
	...
	public boolean prioritize() {
		return opcode == EquipPacketListener.OPCODE || opcode == ItemActionPacketListener.FIRST_ITEM_ACTION_OPCODE
