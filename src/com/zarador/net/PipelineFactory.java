...
import com.zarador.net.login.LoginDecoder;
import com.zarador.net.login.LoginEncoder;
...
public class PipelineFactory implements ChannelPipelineFactory {
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		pipeline.addLast("encoder", new LoginEncoder()); // Replaced by the
															// PacketEncoder
															// after login
		pipeline.addLast("decoder", new LoginDecoder()); // Replaced by the
															// PacketDecoder
															// after login
