...
public class ChatMessage {
	 ...
	 * 
	 * @param message
	 *            The new message they will speak.
	...
	public static class Message {
		 ...
		 * 
		 * @param colour
		 *            The color the message will have, done through color(#):
		 * @param effects
		 *            The effect the message will have, done through effect(#):
		 * @param text
		 *            The actual message it will have.
		 */
