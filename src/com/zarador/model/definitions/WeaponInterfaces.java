...
public final class WeaponInterfaces {
	...
	public enum WeaponInterface {
		...
		STAFF(328, 331, 5, new FightType[] { FightType.STAFF_BASH, FightType.STAFF_POUND, FightType.STAFF_FOCUS }),
		...
		CROSSBOW(1764, 1767, 6, new FightType[] { FightType.CROSSBOW_ACCURATE, FightType.CROSSBOW_RAPID, FightType.CROSSBOW_LONGRANGE }, 7549, 7561),
		SHORTBOW(1764, 1767, 4, new FightType[] { FightType.SHORTBOW_ACCURATE, FightType.SHORTBOW_RAPID, FightType.SHORTBOW_LONGRANGE }, 7549, 7561),
		BALLISTA(1764, 1767, 5, new FightType[] { FightType.BALLISTA_ACCURATE, FightType.BALLISTA_RAPID, FightType.BALLISTA_LONGRANGE }, 7549, 7561),
		...
		SWORD(2276, 2279, 4, new FightType[] { FightType.SWORD_STAB, FightType.SWORD_LUNGE, FightType.SWORD_SLASH, FightType.SWORD_BLOCK }, 7574, 7586),
		...
		LONGSWORD(2423, 2426, 5, new FightType[] {FightType.LONGSWORD_CHOP, FightType.LONGSWORD_SLASH, FightType.LONGSWORD_LUNGE, FightType.LONGSWORD_BLOCK }, 7599, 7611),
		MACE(3796, 3799, 5, new FightType[] {FightType.MACE_POUND, FightType.MACE_PUMMEL, FightType.MACE_SPIKE, FightType.MACE_BLOCK }, 7624, 7636),
		KNIFE(4446, 4449, 3, new FightType[] {FightType.KNIFE_ACCURATE, FightType.KNIFE_RAPID, FightType.KNIFE_LONGRANGE }, 7649, 7661),
		BLOWPIPE(4446, 4449, 4, new FightType[] {FightType.BLOWPIPE_ACCURATE, FightType.BLOWPIPE_RAPID, FightType.BLOWPIPE_LONGRANGE }, 7649, 7661),
		SPEAR(4679, 4682, 5, new FightType[] {FightType.SPEAR_LUNGE, FightType.SPEAR_SWIPE, FightType.SPEAR_POUND, FightType.SPEAR_BLOCK }, 7674, 7686),
		TWO_HANDED_SWORD(4705, 4708, 7, new FightType[] {FightType.TWOHANDEDSWORD_CHOP, FightType.TWOHANDEDSWORD_SLASH, FightType.TWOHANDEDSWORD_SMASH, FightType.TWOHANDEDSWORD_BLOCK }, 7699, 7711),
		PICKAXE(5570, 5573, 5, new FightType[] {FightType.PICKAXE_SPIKE, FightType.PICKAXE_IMPALE, FightType.PICKAXE_SMASH, FightType.PICKAXE_BLOCK }),
		...
		HALBERD(8460, 8463, 7, new FightType[] {FightType.HALBERD_JAB, FightType.HALBERD_SWIPE, FightType.HALBERD_FEND }, 8493, 8505),
		...
		THROWNAXE(4446, 4449, 5, new FightType[] {FightType.THROWNAXE_ACCURATE, FightType.THROWNAXE_RAPID, FightType.THROWNAXE_LONGRANGE }, 7649, 7661),
		 ...
		 *            the id of the special meter for this interface.
		 */
		WeaponInterface(int interfaceId, int nameLineId, int speed, FightType[] fightType, int specialBar,
				int specialMeter) {
		 ...
		 *            the fight types that correspond with this interface.
		 */
		WeaponInterface(int interfaceId, int nameLineId, int speed, FightType[] fightType) {
